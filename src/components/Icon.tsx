...
export const Icon = ({ className }: { className?: string }) => {
    ...
    >
        ...
        <motion.text variants={getTextAnimation('below')} style={{fontSize: '4em'}} x="270" y="380" font-family="Garamond" fill="#914b45"> MARASCO </motion.text>
        ...
        <motion.text variants={getTextAnimation('above')}  style={{fontSize: '4em'}} x="215" y="520" font-family="Garamond" fill="#914b45"> SANTANGELO </motion.text>
